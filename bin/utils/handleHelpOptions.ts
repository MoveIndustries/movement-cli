...
/**
 * Handle the `--help` option for the MovementCLI. This function is used to combine
 * the Movement CLI help output with the Commander help output.
...
export const handleHelpOptions = (
  ...
  // Capture the Movement CLI help output
  const cliHelp = spawnSync(`movement`, unknownOptions, {
    stdio: "pipe",
    encoding: "utf-8",
  });
